...
// saveNewResponse(CourseDB, {courseid: "9cdabd48-c208-4154-a62e-0bf8020739e0", coursename: "CSCI 1040u", coursedesc: " Introduction to Computer Science"});
// saveNewResponse(CourseDB, {courseid: "5f3ea8ac-75aa-426b-8ed1-a98654621834", coursename: "CSCI 3230u", coursedesc: "Web Development"});
...
function LoadCourse(course)
{
	...
	****************************************/
	...
	app.get('/'+courseName+'/lecture_notes', function(request, response){
		...
		fs.readdir(lectureFolder, (err, files) => {
			var Lectures = [];
