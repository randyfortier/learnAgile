...
app.get('/', function(request, response){
    // response.sendFile( __dirname + '/views/sampleLecture.html');
...
app.post('/lecture', function(request, response){
    ...
    else
    {
        ...
        response.sendFile( __dirname + '/views/teacherLecture.html');
    }
});
...
io.on('connection', function(socket){
    socket.on('teacher-moveslide', function(indexies){
